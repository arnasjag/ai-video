...
export const allFilters: FilterConfig[] = [
  // Trending
  { id: 'glam-ai-1', name: 'Glam AI', icon: '✨', category: 'trending', previewImage: getImage(1), creatorName: 'Glam AI', likes: 3200, isPremium: true, price: 9.99, introTitle: 'Glam AI', introSubtitle: 'Transform into your most glamorous self' },
  { id: 'glam-ai-2', name: 'Glam AI', icon: '✨', category: 'trending', previewImage: getImage(2), creatorName: 'Glam AI', likes: 3100, isPremium: true, price: 9.99, introTitle: 'Glam AI', introSubtitle: 'Transform into your most glamorous self' },
  { id: 'jovany-1', name: 'Portrait Pro', icon: '📸', category: 'trending', previewImage: getImage(3), creatorName: 'JovanyPauc', likes: 2800, isNew: true, price: 9.99, introTitle: 'Portrait Pro', introSubtitle: 'Professional portrait enhancement' },
